...
const t = {
  fr: {
    ...
    'about.recognition':'<p><strong>Récépissé N° 0395/MISD-SG-DAPSC-DSC</strong> délivré le 16 avril 2003<br /><strong>Attestation de Qualité N° 460/MCDAT</strong> délivrée le 28 août 2008<br />Opérant dans les régions de <strong>Lomé, Kara et Savanes</strong></p>',
    ...
    'prog.agri.text':'Aide aux paysans en période de soudure alimentaire. Formation en biométhanisation pour une agriculture durable, et soutien au Comité pour le Développement Intégral de Savanes (CODISA).',
    ...
    'impact.label4':'Régions d\'intervention : Lomé, Kara et Savanes (P/Kozah)',
    ...
    'contact.address.text':'Lomé, République Togolaise<br /><small style="color:var(--text-light);">Bureaux régionaux : Kara &amp; Savanes (P/Kozah)</small>',
    ...
    'footer.contact.address':'Lomé, République Togolaise<br />Bureaux à Kara &amp; Savanes',
  ...
  en: {
    ...
    'about.recognition':'<p><strong>Registration N° 0395/MISD-SG-DAPSC-DSC</strong> issued on 16 April 2003<br /><strong>Quality Certificate N° 460/MCDAT</strong> issued on 28 August 2008<br />Operating in the regions of <strong>Lomé, Kara and Savanes</strong></p>',
    ...
    'prog.agri.text':'Assistance to farmers during the lean season. Training in biomethanisation for sustainable agriculture, and support for the Committee for Integral Development of Savanes (CODISA).',
    ...
    'impact.label4':'Regions of operation: Lomé, Kara and Savanes (P/Kozah)',
    ...
    'contact.address.text':'Lomé, Republic of Togo<br /><small style="color:var(--text-light);">Regional offices: Kara &amp; Savanes (P/Kozah)</small>',
    ...
    'footer.contact.address':'Lomé, Republic of Togo<br />Offices in Kara &amp; Savanes',
  ...
  de: {
    ...
    'about.recognition':'<p><strong>Registriernummer N° 0395/MISD-SG-DAPSC-DSC</strong> ausgestellt am 16. April 2003<br /><strong>Qualitätsbescheinigung N° 460/MCDAT</strong> ausgestellt am 28. August 2008<br />Tätig in den Regionen <strong>Lomé, Kara und Savanes</strong></p>',
    ...
    'prog.agri.text':'Unterstützung der Bauern in der Mangelzeit. Ausbildung in Biomethanisierung für eine nachhaltige Landwirtschaft und Unterstützung des Komitees für die integrale Entwicklung von Savanes (CODISA).',
    ...
    'impact.label4':'Interventionsregionen: Lomé, Kara und Savanes (P/Kozah)',
    ...
    'contact.address.text':'Lomé, Republik Togo<br /><small style="color:var(--text-light);">Regionalbüros: Kara &amp; Savanes (P/Kozah)</small>',
    ...
    'footer.contact.address':'Lomé, Republik Togo<br />Büros in Kara &amp; Savanes',
